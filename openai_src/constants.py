...
ASSISTANT_INSTRUCTIONS = (
    ...
    "If the user asks for something to show in response to your previous answer, treat it as a question and call the function."
    "\n"
...
ASSISTANT_TOOLS = [
    {
        ...
        "function": {
            ...
            "description": "Get question or show answer.",
            "strict": True,
            "parameters": {
                "type": "object",
                "properties": {
                "message": {
                    "type": "string",
                    "description": "A message from a user containing a question or call to show. Do not extract or simplify the question; pass the entire message as is, not truncate it. Another model will handle any further processing."
                }
                },
                "required": [
                "message"
...
QUESITON_DECOMPOSITOR_INSTRUCTIONS = (
    "You will be given a question in <main_question> tag. You only need to break up the question in the <main_question> tag\n"
    "into simpler questions according to the conjunctions.\n"
    "\n"
    "In addition, you will be provided with a question and answers history for it in <questions_and_answers_history> tag.\n"
    "Consider the history when formulating the questions after the breakdown so that they are self-contained and the full context is understood, also prefer more recent questions and answers in history.\n"
    "\n"
    "PAY CLOSE ATTENTION TO WHEN THE PAST HISTORY SHOULD BE CONSIDERED AND WHEN NOT, THAT IS, THE MAIN QUESTION IS INDEPENDENT.\n"
    "\n"
    "Questions and answers history can be empty. Each individual question and answer to it in <question_and_answer> tag.\n"
    "In <examples> system instructions, the answers to most questions in the <question_and_answer> body will be omitted,\n"
    "instead it will be \"...\" to save markers, but in the input all <question_and_answer> will have answers.\n"
    "\n"
    ...
    "\n"
    "Also below are several examples in the <examples> tag, each example contained in the <example> tag, which contains input\n"
    "and the answer to them in the <answer> tag.\n"
    "\n"
    "EXAMPLES:\n"
    "<examples>\n"
    "\n"
    "<example>\n"
    "<questions_and_answers_history>\n"
    "</questions_and_answers_history>\n"
    "\n"
    "<main_question>\n"
    "what is the difference between fresh goods and custom made goods and what are the methods?\n"
    "</main_question>\n"
    "\n"
    "<answer>\n"
    "{\n"
    ...
    "<questions_and_answers_history>\n"
    "<question_and_answer>\n"
    "What are the conditions for returning clothes?\n"
    "\n"
    "...\n"
    "</question_and_answer>\n"
    "</questions_and_answers_history>\n"
    ...
    "{\n"
    '  "simpler_questions": [\n'
    '    "What is the return price policy of clothes?"\n'
    "  ]\n"
    "}\n"
    "</answer>\n"
    "</example>\n"
    ...
    "<questions_and_answers_history>\n"
    "<question_and_answer>\n"
    "Hello, what is return price policy and what you can say about glasses?\n"
    "\n"
    "...\n"
    "</question_and_answer>\n"
    "<question_and_answer>\n"
    ...
    "{\n"
    '  "simpler_questions": [\n'
    '    "What is the return price policy of audio?"\n'
    "  ]\n"
    "}\n"
    "</answer>\n"
    "</example>\n"
    ...
    "<questions_and_answers_history>\n"
    "<question_and_answer>\n"
    "Hi, what is the return pricing policy and what methods are available?\n"
    "\n"
    "...\n"
    "<question_and_answer>\n"
    "</questions_and_answers_history>\n"
    "\n"
    "<main_question>\n"
    "What's the difference between fresh compared to made-to-order?\n"
    "</main_question>\n"
    "<answer>\n"
    "{\n"
    '  "simpler_questions": [\n'
    '    "What is the return price policy of fresh items?",\n'
    '    "What is the return price policy of made-to-order items?",\n'
    '    "What are the available return methods?"\n'
    "  ]\n"
    "}\n"
    "</answer>\n"
    "</example>\n"
    ...
    "</question_and_answer>\n"
    "<question_and_answer>\n"
    "ok, what about bag and which methods?\n"
    "\n"
    "...\n"
    "</question_and_answer>\n"
    "</questions_and_answers_history>\n"
    "\n"
    "<main_question>\n"
    "What can you say about the clothing return policy?\n"
    "</main_question>\n"
    "\n"
    "<answer>\n"
    "{\n"
    '  "simpler_questions": [\n'
    '    "What is the return policy of clothes?"\n'
    "  ]\n"
    "}\n"
    "</answer>\n"
    "</example>\n"
    ...
    "\n"
    "<main_question>\n"
    "what you can tell about clothes?\n"
    "</main_question>\n"
    "<answer>\n"
    "{\n"
    '  "simpler_questions": [\n'
    ...
    "\n"
    "For Amazon Global Store items, Amazon will issue a refund within a maximum of 14 days and confirm it with an automated\n"
    "e-mail. You can see the refund in your bank account or credit card statement within a maximum of 7 business days after\n"
    "the refund is issued. In certain circumstances, refund time-frames may be longer. [Amazon Global Store Items]\n"
    "</question_and_answer>\n"
    "</questions_and_answers_history>\n"
    "\n"
    "<main_question>\n"
    ...
    "{\n"
    '  "simpler_questions": [\n'
    '    "What is the refund time for non-Amazon Global Store items?"\n'
    "  ]\n"
    "}\n"
    "</answer>\n"
    "</example>\n"
    ...
    "<questions_and_answers_history>\n"
    "<question_and_answer>\n"
    "what is Kindle return policу?\n"
    "\n"
    "No relevant information. For Kindle, please see the Amazon Devices Returns Policies page, the Kindle and Fire Tablet Terms\n"
    "page and the Amazon Kindle Store Terms of Use page. Non-product-specific sections may contain required information.\n"
    ...
    "{\n"
    '  "simpler_questions": [\n'
    '    "What is the non-product-specific return policy?"\n'
    "  ]\n"
    "}\n"
    "</answer>\n"
    "</example>\n"
...
def QUESTION_DECOMPOSITOR_MESSAGE_BUILD(question, history):
    question_and_answer_history_content = ""
    for e in history:
        question_and_answer_history_content += (
            "<question_and_answer>\n"
            f"{e['question']}\n"
    ...
    question_and_answer_history = (
        "<question_and_answer_history>\n"
        f"{question_and_answer_history_content}"
        "<question_and_answer_history>"
    )

    return (
        f"{question_and_answer_history}\n"
        "\n"
        "<main_question>\n"
        f"{question}\n"
        "<main_question>"
...
INFO_RETRIEVER_INSTRUCTIONS = (
    ...
    "assumption is much greater than for its absence.\n"
    "\n"
